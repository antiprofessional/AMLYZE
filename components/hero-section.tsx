          ...
          <div className="space-y-8">
            ...
            <motion.div variants={fadeIn} className="flex items-center gap-4 text-base text-gray-400">
              <div className="flex -space-x-2">
                {[
                  "https://img1.teletype.in/files/cd/69/cd690908-0157-47ce-a8a4-ff9b05a67cb6.jpeg",
                  "https://img4.teletype.in/files/bd/86/bd86d1dd-eb46-449f-ba94-522bae1468b9.jpeg",
                  "https://img2.teletype.in/files/db/61/db615cb0-c534-4979-ac72-22083192847a.jpeg",
